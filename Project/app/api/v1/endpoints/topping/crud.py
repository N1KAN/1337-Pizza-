...
def create_topping(schema: ToppingCreateSchema, db: Session):
    ...
    db.commit()
    logging.info(
        'Created topping: name={}, price={}, description={}, stock={}'.format(
            entity.name, entity.price, entity.description, entity.stock
        )
    )
    return entity
...
def update_topping(topping: Topping, changed_topping: ToppingCreateSchema, db: Session):
    ...
    db.refresh(topping)
    logging.info(
        'Updated topping: name={}, price={}, description={}, stock={}'.format(
            changed_topping.name, changed_topping.price, changed_topping.description, changed_topping.stock
        )
    )
    return topping
