...
def create_pizza_type(schema: PizzaTypeCreateSchema, db: Session):
    ...
    db.commit()
    logging.info(
        'Created pizza type: name={}, price={}, description={}, dough_id={}'.format(
            entity.name, entity.price, entity.description, entity.dough_id
        )
    )
    return entity
...
def update_pizza_type(pizza_type: PizzaType, changed_pizza_type: PizzaTypeCreateSchema, db: Session):
    ...
    logging.info(
        'Updated pizza type: name={}, price={}, description={}, dough_id={}'.format(
            pizza_type.name, pizza_type.price, pizza_type.description, pizza_type.dough_id
        )
    )
    return pizza_type
...
def create_topping_quantity(
    ...
    db.refresh(pizza_type)
    logging.info(
        'Created pizza type topping: quantity={}, topping_id={}'.format(
            entity.quantity, entity.topping_id
        )
    )
    return entity
